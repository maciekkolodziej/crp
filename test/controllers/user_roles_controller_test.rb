...
class UserRolesControllerTest < ActionController::TestCase
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post :create, user_role: { role_id: @user_role.role_id, store_id: @user_role.store_id, user_id: @user_role.user_id }
    end
  ...
  test "should update user_role" do
    patch :update, id: @user_role, user_role: { role_id: @user_role.role_id, store_id: @user_role.store_id, user_id: @user_role.user_id }
    assert_redirected_to user_role_path(assigns(:user_role))
  end
